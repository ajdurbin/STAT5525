...
The following code constructs a classification tree similar to above, though we use prune the tree with the minimal complexity parameter.
...
So we see there is an improvement after pruning the tree.

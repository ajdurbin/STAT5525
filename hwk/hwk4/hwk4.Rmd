...
In order to make a "reliable" Scree plot, we iterated over 29 possible values of *k* and drew 1000 realizations of *k*-means for each *k*. Our "best" realizations were those with smallest total within cluster sum of squares. From the plot, we see marginal decreases in variability for $k>9$.
